...
echo -e "Building image shipping-service:latest!\n"
...
# docker tag shipping-service:latest indra26dev/shipping-service:latest

# jika menggunakan  github packages
docker tag shipping-service:latest ghcr.io/indra-yana/shipping-service:latest
...
# jika menggunakan docker hub
# docker push indra26dev/shipping-service:latest

# jika menggunakan github packages
docker push ghcr.io/indra-yana/shipping-service:latest
