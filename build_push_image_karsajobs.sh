...
echo -e "Building image karsajobs:latest!\n"
...
# docker tag karsajobs:latest indra26dev/karsajobs:latest

# jika menggunakan  github packages
docker tag karsajobs:latest ghcr.io/indra-yana/karsajobs:latest
...
# jika menggunakan docker hub
# docker push indra26dev/karsajobs:latest
